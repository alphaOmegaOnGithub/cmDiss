...
%\addbibresource{myRefBib}
\addbibresource{sample.bib} %Import the bibliography file
\usepackage{csquotes} %Imports csquotes package
...
\title{A Governance Specific Language for the Enterprise Information Management (EIM) Domain}
\author{You}
...
\section{Citations and a References List}
